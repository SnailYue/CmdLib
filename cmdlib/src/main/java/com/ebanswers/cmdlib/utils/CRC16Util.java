...
public class CRC16Util {
     ...
     * @return CRC16校验值
     */
    public static int calcCrc16(List<Byte> val, int start, int end) {
        if (val.size() <= end) {
            return 0;
        }
        int len = end - start + 1;
        ...
        return calcCrc16(data, 0, len, 0xffff);
    }
    ...
    public static int calcCrc16Low(byte[] data, int offset, int len, int preval) {
        int ucCRCHi = (preval & 0xff00) >> 8;
        int ucCRCLo = preval & 0x00ff;
        int iIndex;
        for (int i = 0; i < len; ++i) {
    ...
    public static int calcCrc16High(byte[] data, int offset, int len, int preval) {
        int ucCRCHi = (preval & 0xff00) >> 8;
        int ucCRCLo = preval & 0x00ff;
        int iIndex;
        for (int i = 0; i < len; ++i) {
     ...
     * @return
     */
    public static int crc16_xmodem(byte[] bytes, int offset, int count) {
        int crc = 0x0000;
